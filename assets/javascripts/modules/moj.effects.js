...
moj.Modules.effects = (function() {
  ...
  /*
    DEPENDENCIES
    ============
    jQuery, moj, some method of animating colours

    jQuery cannot animate colours natively so unless you already have jQuery UI installed, a plugin is needed.
    Try one of:
    ...
    trigger fade effect on multiple elements with common className and custom colour and/or duration:
